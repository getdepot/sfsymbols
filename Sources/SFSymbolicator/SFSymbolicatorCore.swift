...
//  
//
//  Created by Eric Anderson on 11/4/20.
//

import Foundation

struct SFSymbolicatorCore {
    ...
    enum Category: String, CaseIterable {
        ...
        func symbols() -> [String] {
            switch self {
                case .Communications: return SFSymbolicatorCore().communications
                case .Weather: return SFSymbolicatorCore().weather
                case .ObjectsAndTools: return SFSymbolicatorCore().objectsandtools
                case .Devices: return SFSymbolicatorCore().devices
                case .Gaming: return SFSymbolicatorCore().gaming
                case .Connectivity: return SFSymbolicatorCore().connectivity
                case .Transportation: return SFSymbolicatorCore().transportation
                case .Human: return SFSymbolicatorCore().human
                case .Nature: return SFSymbolicatorCore().nature
                case .Editing: return SFSymbolicatorCore().editing
                case .TextFormatting: return SFSymbolicatorCore().textformatting
                case .Media: return SFSymbolicatorCore().media
                case .Keyboard: return SFSymbolicatorCore().keyboard
                case .Commerce: return SFSymbolicatorCore().commerce
                case .Time: return SFSymbolicatorCore().time
                case .Health: return SFSymbolicatorCore().health
                case .Shapes: return SFSymbolicatorCore().shapes
                case .Arrows: return SFSymbolicatorCore().arrows
                case .Indices: return SFSymbolicatorCore().indices
                case .Math: return SFSymbolicatorCore().math
            }
        }
        
        func symbols(containing: String) -> [String] {
    ...
    private let objectsandtools: [String] = [
        "pencil",
        "pencil.circle",
        "pencil.circle.fill",
        "pencil.slash",
    ...
    private let textformatting: [String] = [
        "paragraphsign",
        "list.dash",
        "list.bullet",
        "list.triangle",
